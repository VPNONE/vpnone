...
from vpnone.common import to_bytes, to_str, IPNetwork
from vpnone import encrypt
...
def print_vpnone():
    ...
    try:
        ...
        version = pkg_resources.get_distribution('vpnone').version
    except Exception:
        pass
    print('vpnone %s' % version)
...
def get_config(is_local):
    ...
    config['pid-file'] = config.get('pid-file', '/var/run/vpnone.pid')
    config['log-file'] = config.get('log-file', '/var/log/vpnone.log')
...
Online help: <https://github.com/vpnone/vpnone>
''')
