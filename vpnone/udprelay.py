...
# vpnone UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# vpnone UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# vpnone UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of vpnone
# `remote`  means remote server of vpnone
...
from vpnone import encrypt, eventloop, lru_cache, common, shell
from vpnone.common import parse_header, pack_addr, onetimeauth_verify, \
...
class UDPRelay(object):
    ...
    def _handle_server(self):
        ...
        if self._is_local:
            ...
            # spec https://vpnone.org/en/spec/one-time-auth.html
